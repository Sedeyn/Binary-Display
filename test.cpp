...
void Leds::pink(int ledpin, int tijd) {
...
void Leds::binairConvert(int waarde) {
...
void Leds::binairAdd(int waarde1, int waarde2) {

    binairConvert(waarde1);
    delay(1000);
    binairConvert(waarde2);
    delay(1000);
    binairConvert(waarde1 + waarde2);
    delay(1500);
}
